...
// Define speed levels with voltage compensation
#define TK_STOP_SPEED          0
#define TK_FORWARD_SPEED        (90 + tk_VoltageCompensationToSpeed    )

// Define different speed levels with voltage compensation
...
void loop() {
  ...
  {
    case 0:   // 000
      motorRun(TK_FORWARD_SPEED, TK_FORWARD_SPEED); // Car moves forward
      break;
    case 7:   // 111
      motorRun(TK_STOP_SPEED, TK_STOP_SPEED); // Car stops
      break;
    case 1:   // 001
      motorRun(TK_TURN_SPEED_LV4, TK_TURN_SPEED_LV1); // Car turns
      break;
    case 3:   // 011
      motorRun(TK_TURN_SPEED_LV3, TK_TURN_SPEED_LV2); // Car turns right
      break;
    case 2:   // 010
    case 5:   // 101
      motorRun(TK_FORWARD_SPEED, TK_FORWARD_SPEED);  // Car moves forward
      break;
    case 6:   // 110
      motorRun(TK_TURN_SPEED_LV2, TK_TURN_SPEED_LV3); // Car turns left
      break;
    case 4:   // 100
      motorRun(TK_TURN_SPEED_LV1, TK_TURN_SPEED_LV4); // Car turns right
      break;
    default:
      break;
  }
...
void pinsSetup() {
  ...
  // Define ultrasonic module pin modes
  pinMode(PIN_SONIC_TRIG, OUTPUT);
  pinMode(PIN_SONIC_ECHO, INPUT);
  // Define tracking sensor pin modes
...
void motorRun(int speedl, int speedr) {
  ...
  speedl = constrain(speedl, 0, 255); // Ensure speedl is within 0~255
  speedr = constrain(speedr, 0, 255); // Ensure speedr is within 0~255
